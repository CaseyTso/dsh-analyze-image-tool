    ...
    function SettingsPanel(props) {
      ...
      if (form === null) {
        return el(
          ...
          el("button", { type: "button", style: actionStyle, onClick: props.onClose }, "关闭"),
        );
      }
      ...
      return el(
        ...
        el("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
          ...
          el("button", { type: "button", style: buttonStyle, onClick: props.onClose }, "×")),
        ...
        el("div", { style: { display: "flex", flexDirection: "column", gap: 6, padding: "6px 0", borderBottom: "1px solid var(--dsh-color-border, #80808040)" } },
          ...
          el("div", { style: { display: "flex", gap: 6 } },
            ...
            el("button", { type: "button", style: buttonStyle, onClick: deleteProfile, disabled: saveState === "saving" || selectedProfileId === activeProfile }, "删除")),
          el("div", { style: { display: "flex", gap: 6 } },
            el("input", {
              type: "text",
              value: profileName,
